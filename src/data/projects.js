...
export const projects = [
  ...
  },
  {
    ...
    category: "Web Apps",
    description:
      "A Tic Tac Toe game built with a focus on responsive design and smooth user experience. Designed to showcase component-based architecture, state management, and efficient rendering in a modern frontend stack.",
    techStack: [
      "JavaScript",
      "HTML5",
      "CSS3",
    ...
    image: tictactoe,
    demoUrl: "https://jimmydla.github.io/react-ttt/",
    sourceUrl: "https://github.com/JimmyDLA/react-ttt/tree/master",
  },
  {
    id: 3,
    title: "Retro Snake",
